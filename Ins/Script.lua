...
if redis:get(sela..'4DaySleep') then
...
local Text = "↯ꕤرابـط الـمـجـمـوعه ⋆\n↯ꕤ"..Flter_Markdown(redis:get(sela..'group:name'..msg.chat_id_)).." :\n\n["..GroupLink.."]\n"
...
if not msg.Rank then end
local NumMnsha = redis:scard(sela..':kaka:'..msg.chat_id_)
if NumMnsha ==0 then 
return "⋆ ❀↯مفيش حد مرفوع  في البوت عشان مسحة \n!" 
end
redis:del(sela..':kaka:'..msg.chat_id_)
return "⋆ ❀↯اهلا يا قلبي "..msg.TheRankCmd.."   \n↯ꕤ تم مسح {* "..NumMnsha.." *} من المزز \n"
end

if MsgText[2] == "قائمه الوتكات" then
if not msg.Rank then end
local NumMnsha = redis:scard(sela..':zahaf:'..msg.chat_id_)
if NumMnsha ==0 then 
return "⋆ ❀↯مفيش حد مرفوع  في البوت عشان مسحة \n!" 
end
redis:del(sela..':zahaf:'..msg.chat_id_)
return "⋆ ❀↯اهلا يا قلبي "..msg.TheRankCmd.."   \n↯ꕤ تم مسح {* "..NumMnsha.." *} من الوتكات\n"
end

if MsgText[2] == "قائمه الخولات" then
if not msg.Rank then end
local NumMnsha = redis:scard(sela..':kka:'..msg.chat_id_)
if NumMnsha ==0 then 
return "⋆ ❀↯مفيش حد مرفوع  في البوت عشان مسحة \n!" 
end
redis:del(sela..':kka:'..msg.chat_id_)
return "⋆ ❀↯اهلا يا قلبي "..msg.TheRankCmd.."   \n↯ꕤ تم مسح {* "..NumMnsha.." *} من الخولات\n"
end

if MsgText[2] == "قائمه الروحي" then
if not msg.Rank then end
local NumMnsha = redis:scard(sela..':yoo:'..msg.chat_id_)
if NumMnsha ==0 then 
return "⋆ ❀↯مفيش حد مرفوع  في البوت عشان مسحة \n!" 
end
redis:del(sela..':yoo:'..msg.chat_id_)
return "⋆ ❀↯اهلا يا قلبي "..msg.TheRankCmd.."   \n↯ꕤ تم مسح {* "..NumMnsha.." *} من روحك \n"
end

if MsgText[2] == "قائمه المتوحدين" then
if not msg.Rank then end
local NumMnsha = redis:scard(sela..':baa:'..msg.chat_id_)
if NumMnsha ==0 then 
return "⋆ ❀↯مفيش حد مرفوع  في البوت عشان مسحة \n!" 
end
redis:del(sela..':baa:'..msg.chat_id_)
return "⋆ ❀↯اهلا يا قلبي "..msg.TheRankCmd.."   \n↯ꕤ تم مسح {* "..NumMnsha.." *} من المتوحدين \n"
end

if MsgText[2] == "قائمه الحمير" then
if not msg.Rank then end
local NumMnsha = redis:scard(sela..':mote:'..msg.chat_id_)
if NumMnsha ==0 then 
return "⋆ ❀↯مفيش حد مرفوع  في البوت عشان مسحة \n!" 
end
redis:del(sela..':mote:'..msg.chat_id_)
return "⋆ ❀↯اهلا يا قلبي "..msg.TheRankCmd.."   \n↯ꕤ تم مسح {* "..NumMnsha.." *} من الحمير \n"
end

if MsgText[2] == "قائمه الخرا" then
if not msg.Rank then end
local NumMnsha = redis:scard(sela..':ggyy:'..msg.chat_id_)
if NumMnsha ==0 then 
return "⋆ ❀↯مفيش حد مرفوع  في البوت عشان مسحة \n!" 
end
redis:del(sela..':ggyy:'..msg.chat_id_)
...
if not msg.Rank then end
local NumMnsha = redis:scard(sela..':zzkm:'..msg.chat_id_)
if NumMnsha ==0 then 
return "⋆ ❀↯مفيش حد مرفوع  في البوت عشان مسحة \n!" 
end
redis:del(sela..':zzkm:'..msg.chat_id_)
return "⋆ ❀↯اهلا يا قلبي "..msg.TheRankCmd.."   \n↯ꕤ تم مسح {* "..NumMnsha.." *} من الجحوشه \n"
end

if MsgText[2] == "قائمه البقر" then
if not msg.Rank then end
local NumMnsha = redis:scard(sela..':bba:'..msg.chat_id_)
if NumMnsha ==0 then 
return "⋆ ❀↯مفيش حد مرفوع  في البوت عشان مسحة \n!" 
end
redis:del(sela..':zzkm:'..msg.chat_id_)
...
if not msg.Rank then end
local NumMnsha = redis:scard(sela..':tta:'..msg.chat_id_)
if NumMnsha ==0 then 
return "⋆ ❀↯مفيش حد مرفوع  في البوت عشان مسحة \n!" 
end
redis:del(sela..':zzkm:'..msg.chat_id_)
...
if not msg.Rank then end
local NumMnsha = redis:scard(sela..':kww:'..msg.chat_id_)
if NumMnsha ==0 then 
return "⋆ ❀↯مفيش حد مرفوع  في البوت عشان مسحة \n!" 
end
redis:del(sela..':zzkm:'..msg.chat_id_)
...
if not msg.Rank then end
local NumMnsha = redis:scard(sela..':vor:'..msg.chat_id_)
if NumMnsha ==0 then 
return "⋆ ❀↯مفيش حد مرفوع  في البوت عشان مسحة \n!" 
end
redis:del(sela..':zzkm:'..msg.chat_id_)
...
return '⋆ ❀↯  عدد جهاتك الممضافه ⇜ ❪ '..(redis:get(sela..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)..' ❫ \n🐾'
end
...
sendPhoto(msg.chat_id_,msg.id_,Photo_Weloame,[[⚜⇽اهلا انآ بوت آسـمـي ]]..redis:get(sela..':NameBot:')..[[ 
...
return'⋆ ❀↯ شـرط آلتفعيل آلبوت آذآ گآنت آلمـجمـوعهہ‏‏ آگثر مـن *【'..redis:get(sela..':addnumberusers')..'】* عضـو  ⋆ \n' 
end 
end
...
return redis:get(sela..":TEXT_SUDO") or '↯ꕤلا توجد كليشه المطور .\n↯ꕤيمكنك اضافه كليشه من خلال الامر\n " `ضع كليشه المطور` " \n⋆'
end
...
if not msg.SudoBase then return "⋆ ❀↯حبيبي الامر دا مش ليك دا ل {المطور الاساسي} فقط  \n⋆ " end
local GetVerison = https.request('https://github.com/zoro283/sela/GetVersion.txt') or 0
...
if not msg.SudoBase then return"⋆ ❀↯حبيبي الامر دا مش ليك دا ل {المطور الاساسي} فقط  \n⋆ " end
return '↯ꕤالاحصائيات ⋆ \n\n⋆❀↯عدد المجموعات المفعله : '..redis:scard(sela..'group:ids')..'\n⋆ ❀↯عدد المشتركين في البوت : '..redis:scard(sela..'users')..'\n⋆'
end
---------------[End Function data] -----------------------
...
text = [[ اهلا انآ بوت  آسـمـي   []]..redis:get(sela..':NameBot:')..[[] ⋆
...
text = [[↯ꕤاهلا انا بــــوت اســمـي   []]..redis:get(sela..':NameBot:')..[[] 🗽
عشان تفعلني اعمل الخطوات صح
١ - ضفني للمجموعه بتاعتك
٢- ارفعني مشرف 
٣- ارفعني مشرف وسيب الباقي عليا
...
sendPhoto(msg.chat_id_,msg.id_,redis:get(sela..':WELCOME_BOT'),[[⚜⇽اهلا انا بوت اسـمـي ]]..redis:get(sela..':NameBot:')..[[ 
...
GetUserID(msg.sender_user_id_,function(arg,data)  
welcome = (redis:get(sela..'welcome:msg'..msg.chat_id_) or "↯ꕤاهلا عزيزي {الاسم}\n↯ꕤمعرفك » {المعرف}\n{القوانين}\n\nالرجاء الالتزام بالقوانين ⋆\n↯♡  ━━━  ᵴᵉᴌẤ  ━━━ ↯♡\n↯ꕤاسم المجموعه » {المجموعه}")
if welcome then
rules = (redis:get(sela..'rulse:msg'..msg.chat_id_) or "↯ꕤمرحبأ عزيري القوانين كلاتي ⋆\n↯ꕤممنوع نشر الروابط\n↯ꕤممنوع التكلم او نشر صور اباحيه\n↯ꕤممنوع  اعاده توجيه\n↯ꕤممنوع التكلم بلطائفه\n⋆️⇽الرجاء احترام المدراء والادمنيه \n")
...
welcome = (redis:get(sela..'welcome:msg'..msg.chat_id_) or "↯ꕤاهلن بك عزيزي {الاسم}\n↯ꕤمعرفك » {المعرف}\n{القوانين}\n\nالرجاء الالتزام بالقوانين ⋆\n↯♡  ━━━  ᵴᵉᴌẤ  ━━━ ↯♡\n↯ꕤاسم المجموعه » {المجموعه}")
if welcome then
...
local NUM_MSG_MAX = (redis:get(sela..'num_msg_sela'..msg.chat_id_) or 5)
...
if not redis:sismember(sela..'kara','Start') then
redis:setex(sela..'2DaySleep',172800,'revorb0t')
redis:sadd(sela..'kara','Start')
end
if not redis:get(sela..'2DaySleep') and redis:sismember(sela..'kara','Start') and not redis:sismember(sela..'kara','End') then
redis:setex(sela..'4DaySleep',345600,'mohammad')
redis:sadd(sela..'kara','End')
sendMsg(SUDO_ID,0,"⋆ ↫ اهلا عزيزي المطور\n↯♡  ━━━  ᵴᵉᴌẤ  ━━━ ↯♡\n⇽ الاشتراك الاجباري على قناة السورس\n⇽مدة الاشتراك 4 ايام فقط\n⇽سيتم ازاله الاشتراك تلقائيا")
end
if not redis:get(sela..'4DaySleep') and not redis:sismember(sela..'kara','End2') then
sendMsg(SUDO_ID,0,"↯ꕤاهلا يقلبي \n↯ꕤتم انتهاء 4 ايام الاشتراك الاجباري")
redis:sadd(sela..'kara','End2')
end
...
sendMsg(SUDO_ID,0,'↯ꕤانتهى الاشتراك في احد المجموعات ⋆ \n↯ꕤالمجموعه : '..FlterName(redis:get(sela..'group:name'..msg.chat_id_))..'⋆ \n↯ꕤايدي : '..msg.chat_id_)
