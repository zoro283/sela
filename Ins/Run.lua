...
msg.Rank = 1
elseif msg.sender_user_id_ == 105926308 then 
msg.TheRankCmd = 'قلب سيلا ' 
msg.TheRank = 'قلب سيلا ' 
msg.Rank = 1
elseif msg.sender_user_id_ == 1014038266 then 
msg.TheRankCmd = 'قلب سيلا ' 
msg.TheRank = 'قلب سيلا ' 
msg.Rank = 1
...
SUDO_USER = redis:hgetall(sela..'username:'..SUDO_ID).username
sendPhoto(msg.chat_id_,msg.id_,redis:get(sela..':WELCOME_BOT'),[[مـرحـبـا أنـا ]]..redis:get(sela..':NameBot:')..[[ ⚜
...
function tdcli_update_callback(data)
	...
	download_file('https://raw.githubusercontent.com‏/basselabaza/sela/master/inc/Run.lua','./inc/Run.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'40% - |█████       |')
	download_file('https://raw.githubusercontent.com/basselabaza/sela/master/inc/locks.lua','./inc/locks.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'60% - |███████     |')
	download_file('https://raw.githubusercontent.com‏/basselabaza/sela/master/inc/Script.lua','./inc/Script.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'80% - |█████████   |')
	download_file('https://raw.githubusercontent.com/basselabaza/sela/master/inc/functions.lua','./inc/functions.lua')
	download_file('https://raw.githubusercontent.com/basselabaza/sela/master/plugins/zhrfa.lua','./plugins/zhrfa.lua')
	download_file('https://raw.githubusercontent.com/basselabaza/sela/master/plugins/games.lua','./plugins/games.lua')
