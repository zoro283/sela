...
tokenJoin = '1132717386:AAFLGVKFXCfaMaycxzr_je1ExrBItxmXYcA'
...
local monsha = redis:smembers(sela..':vor:'..msg.chat_id_)
if #monsha == 0 then 
...
local monsha = redis:smembers(sela..':bba:'..msg.chat_id_)
if #monsha == 0 then 
message = message .."⋆⇽ مفيش حد مرفوع في البوت\n❕"
else
for k,v in pairs(monsha) do
...
local monsha = redis:smembers(sela..':kww:'..msg.chat_id_)
if #monsha == 0 then 
message = message .."⋆⇽ مفيش حد مرفوع في البوت\n❕"
else
for k,v in pairs(monsha) do
...
local monsha = redis:smembers(sela..':tta:'..msg.chat_id_)
if #monsha == 0 then 
message = message .."⋆⇽ مفيش حد مرفوع في البوت\n❕"
else
for k,v in pairs(monsha) do
...
local monsha = redis:smembers(sela..':kaka:'..msg.chat_id_)
if #monsha == 0 then 
message = message .."⋆⇽ مفيش حد مرفوع في البوت\n❕"
else
for k,v in pairs(monsha) do
...
local monsha = redis:smembers(sela..':ssee:'..msg.chat_id_)
if #monsha == 0 then 
message = message .."⋆⇽ مفيش حد مرفوع في البوت\n❕"
else
for k,v in pairs(monsha) do
...
local monsha = redis:smembers(sela..':kka:'..msg.chat_id_)
if #monsha == 0 then 
message = message .."⋆⇽ مفيش حد مرفوع في البوت\n❕"
else
for k,v in pairs(monsha) do
...
local monsha = redis:smembers(sela..':yoo:'..msg.chat_id_)
if #monsha == 0 then 
message = message .."⋆⇽ مفيش حد مرفوع في البوت\n❕"
else
for k,v in pairs(monsha) do
...
local monsha = redis:smembers(sela..':baa:'..msg.chat_id_)
if #monsha == 0 then 
message = message .."⋆⇽ مفيش حد مرفوع في البوت\n❕"
else
for k,v in pairs(monsha) do
...
local monsha = redis:smembers(sela..':ggyy:'..msg.chat_id_)
if #monsha == 0 then 
message = message .."⋆⇽ مفيش حد مرفوع في البوت\n❕"
else
for k,v in pairs(monsha) do
...
local monsha = redis:smembers(sela..':mote:'..msg.chat_id_)
if #monsha == 0 then 
message = message .."⋆⇽ مفيش حد مرفوع في البوت\n❕"
else
for k,v in pairs(monsha) do
...
local monsha = redis:smembers(sela..':zmm:'..msg.chat_id_)
if #monsha == 0 then 
message = message .."⋆⇽ مفيش حد مرفوع في البوت\n❕"
else
for k,v in pairs(monsha) do
...
local monsha = redis:smembers(sela..':zzkm:'..msg.chat_id_)
if #monsha == 0 then 
message = message .."⋆⇽ مفيش حد مرفوع في البوت\n❕"
else
for k,v in pairs(monsha) do
...
local creator = redis:smembers(sela..':MONSHA_BOT:'..GroupS)
if #creator ~= 0 then
...
if redis:get(sela..'group:add'..msg.chat_id_) then  return '⋆ ↯♡↯المجموعه  بالتأكيد تم تفعيلها' end
...
if not redis:get(sela..'group:add'..msg.chat_id_) then return '↯♡↯ المجموعه اتعطلت اذا اردت مميزاتي مره اخري اكتب تفعيل' end  
...
if redis:sismember(sela..':vor:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆⇽العضو » ❪ '..USERNAME..' ❫\n⋆⇽الايدي » ❪ '..UserID..' ❫\n⋆⇽انه بالتأكيد ثور \n✓️',17,USERCAR) 
end
redis:sadd(sela..':vor:'..ChatID,UserID)
...
if redis:sismember(sela..':kaka:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆⇽العضو » ❪ '..USERNAME..' ❫\n⋆⇽الايدي » ❪ '..UserID..' ❫\n⋆⇽انه بالتأكيد كيكه \n✓️',17,USERCAR) 
end
redis:sadd(sela..':kaka:'..ChatID,UserID)
...
if redis:sismember(sela..':zahaf:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆⇽العضو » ❪ '..USERNAME..' ❫\n⋆⇽الايدي » ❪ '..UserID..' ❫\n⋆⇽انه بالتأكيد رفع خول\n✓️',17,USERCAR) 
end
redis:sadd(sela..':zahaf:'..ChatID,UserID)
...
if redis:sismember(sela..':kka:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆⇽العضو » ❪ '..USERNAME..' ❫\n⋆⇽الايدي » ❪ '..UserID..' ❫\n⋆⇽انه بالتأكيد كلب\n✓️',17,USERCAR) 
end
redis:sadd(sela..':kka:'..ChatID,UserID)
...
if redis:sismember(sela..':yoo:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆⇽العضو » ❪ '..USERNAME..' ❫\n⋆⇽الايدي » ❪ '..UserID..' ❫\n⋆⇽انه بالتأكيد عره \n✓️',17,USERCAR) 
end
redis:sadd(sela..':yoo:'..ChatID,UserID)
...
if redis:sismember(sela..':baa:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆⇽العضو » ❪ '..USERNAME..' ❫\n⋆⇽الايدي » ❪ '..UserID..' ❫\n⋆⇽انه بالتأكيد بقرة \n✓️',17,USERCAR) 
end
redis:sadd(sela..':baa:'..ChatID,UserID)
...
if redis:sismember(sela..':ggyy:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆⇽العضو » ❪ '..USERNAME..' ❫\n⋆⇽الايدي » ❪ '..UserID..' ❫\n⋆⇽انه بالتأكيد قرد \n✓️',17,USERCAR) 
end
redis:sadd(sela..':ggyy:'..ChatID,UserID)
...
if redis:sismember(sela..':mote:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆⇽العضو » ❪ '..USERNAME..' ❫\n⋆⇽الايدي » ❪ '..UserID..' ❫\n⋆⇽انه بالتأكيد حمار\n✓️',17,USERCAR) 
end
redis:sadd(sela..':mote:'..ChatID,UserID)
...
if redis:sismember(sela..':zmm:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆⇽العضو » ❪ '..USERNAME..' ❫\n⋆⇽الايدي » ❪ '..UserID..' ❫\n⋆⇽انه بالتأكيد وتكه \n✓️',17,USERCAR) 
end
redis:sadd(sela..':zmm:'..ChatID,UserID)
...
if redis:sismember(sela..':bba:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆⇽العضو » ❪ '..USERNAME..' ❫\n⋆⇽الايدي » ❪ '..UserID..' ❫\n⋆⇽انه بالتأكيد متوحده\n✓️',17,USERCAR) 
end
redis:sadd(sela..':bba:'..ChatID,UserID)
...
if redis:sismember(sela..':tta:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆⇽العضو » ❪ '..USERNAME..' ❫\n⋆⇽الايدي » ❪ '..UserID..' ❫\n⋆⇽انه بالتأكيد ذبانه\n✓️',17,USERCAR) 
end
redis:sadd(sela..':tta:'..ChatID,UserID)
...
if redis:sismember(sela..':kww:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆⇽العضو » ❪ '..USERNAME..' ❫\n⋆⇽الايدي » ❪ '..UserID..' ❫\n⋆⇽انه بالتأكيد مزه\n✓️',17,USERCAR) 
end
redis:sadd(sela..':kww:'..ChatID,UserID)
...
if redis:sismember(sela..':zzkm:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆⇽العضو » ❪ '..USERNAME..' ❫\n⋆⇽الايدي » ❪ '..UserID..' ❫\n⋆⇽انه بالتأكيد خرا \n✓️',17,USERCAR) 
end
redis:sadd(sela..':zzkm:'..ChatID,UserID)
...
return sendMsg(ChatID,MsgID,"⋆ ↯♡↯لا يمكنني تقيد او كتم او حظر قلب سيلا\n") 
elseif  UserID == 1014038266 then 
return sendMsg(ChatID,MsgID,"⋆ ↯♡↯لا يمكنني تقيد او كتم او حظر قلب سيلا\n") 
elseif UserID == SUDO_ID then 
return sendMsg(ChatID,MsgID,"⋆ ↯♡↯لا يمكنك تقييد روح سيلا\n") 
elseif redis:sismember(sela..':SUDO_BOT:',UserID) then 
...
return sendMsg(ChatID,MsgID,"⋆ ↯♡↯لا يمكنني تقيد او كتم او حظر قلب سيلا\n") 
elseif UserID == SUDO_ID then 
return sendMsg(ChatID,MsgID,"⋆ ↯♡↯لا يمكنك حظر روح سيلا\n") 
elseif redis:sismember(sela..':SUDO_BOT:',UserID) then 
...
return sendMsg(ChatID,MsgID,"⋆ ↯♡↯لا يمكنني تقيد او كتم او حظر قلب سيلا\n") 
elseif UserID == SUDO_ID then 
return sendMsg(ChatID,MsgID,"⋆ ↯♡↯لا يمكنك كتم روح سيلا\n") 
elseif redis:sismember(sela..':SUDO_BOT:',UserID) then 
...
return sendMsg(ChatID,MsgID,"⋆ ↯♡↯لا يمكنني تقيد او كتم او حظر قلب سيلا\n") 
elseif UserID == SUDO_ID then 
return sendMsg(ChatID,MsgID,"⋆ ↯♡↯لا يمكنك طرد روح سيلا\n") 
elseif redis:sismember(sela..':SUDO_BOT:',UserID) then 
...
if cmd == "dn_sudo" then
if not redis:sismember(sela..':SUDO_BOT:',UserID) then return sendMsg(ChatID,MsgID,'⋆ ↯♡↯العضو » '..USERNAME..' \n⋆ ↯♡↯ الايدي » (`'..UserID..'`)\n⋆ ↯♡↯انه بالتأكيد ليس مطور \n✓') end
redis:srem(sela..':SUDO_BOT:',UserID) 
return SendMention(ChatID,UserID,MsgID,'↯♡↯ العضو » ❪ '..USERNAME..' ❫\n↯♡↯ الايدي » ❪ '..UserID..' ❫\n↯♡↯ تم تنزيله من المطورين \n✓️',17,USERCAR) 
end
