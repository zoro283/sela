...
name = string.gsub(name," دحوو6م ","  هل يعجبك باسل ام  حجاج  ؟ ")
...
name = string.gsub(name," دحوو38م "," اي رايك في المجال وعدم سلكانه؟ ")
...
name = string.gsub(name," دحوو118م "," لي في اخر كل خناقه او كلام تخلص بمعلش ؟ ")
