...
if text == 'مسح كليشه ستارت ♡' and DevBOYKAW(msg) then 
...
os.execute('wget https://raw.githubusercontent.com/zoro283/BOYKA/master/BOYKA.lua')
...
if text == "مسح رساله الاشتراك ♡" and DevBOYKAW(msg) then  
