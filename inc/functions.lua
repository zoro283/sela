...
tokenJoin = '1317339255:AAHDOLd-xArGlqpXcH5qFjulH9buti83SDQ'
...
.."\n*ط│*البوتات «» "..(redis:get(max..'lock_bots'..msg.chat_id_) or 'false')
.."\n*ط╽*عدد التكرار «» "..(redis:get(max..'num_msg_max'..msg.chat_id_) or 'false')
.."\n┄─┅═ـ═┅─┄\n*👨‍💻*اعدادات التقـييد :\n"
...
.."\nط🎥╽*التقييد الفيديو «» "..(redis:get(max..':tqeed_video:'..msg.chat_id_) or 'false')
list_settings = list_settings:gsub('true', '❬ مقفول ❭')
list_settings = list_settings:gsub('false', '❬ مفتوح ❭')
...
.."\n*╿*المتحركه «» "..(redis:get(max..'mute_gif'..msg.chat_id_) or 'false')
.."\n*ط│*الدردشه «» "..(redis:get(max..'mute_text'..msg.chat_id_) or 'false')
.."\n*ط│*الانلاين «» "..(redis:get(max..'mute_inline'..msg.chat_id_) or 'false')
.."\n*ط│*الالعاب «» "..(redis:get(max..'mute_game'..msg.chat_id_) or 'false')
.."\n*│* الصور «» "..(redis:get(max..'mute_photo'..msg.chat_id_) or 'false')
.."\n*│*الفيديو «» "..(redis:get(max..'mute_video'..msg.chat_id_) or 'false')
.."\n*│*البصمات «» "..(redis:get(max..'mute_audio'..msg.chat_id_) or 'false')
.."\n*│*الصوت «» "..(redis:get(max..'mute_voice'..msg.chat_id_) or 'false')
