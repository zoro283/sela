...
if redis:get(max.."getidstatus"..msg.chat_id_) == "Photo" then
	if data.photos_[0] then 
		...
		sendPhoto(msg.chat_id_,msg.id_,data.photos_[0].sizes_[1].photo_.persistent_id_,'↯ꕤU S E R  ['..UserNameID..']\n↯ꕤI D  ❪ '..msg.sender_user_id_..' ❫\n↯ꕤS T U ❪ '..msg.TheRank..' ❫\n↯ꕤM S G ❪ '..msgs..' ❫')
		else
...
local inline = {{{text="⚜⇽قناه السـورس ضـغـط هنا ",url="t.me/AMR_DIA_B"}}}
send_key(msg.sender_user_id_,'  [⚜⇽قناة سورس : سيلا](t.me/AMR_DIA_B)',nil,inline,msg.id_)
return false
end
