...
name_bot = (faederdx1:get(FAEDER..'name_bot') or 'فـارس')
...
faederdx113(chat,msg.id_,"*☆↯هذا الملف ليس تابع لسورس فـارس ،*")   
return false 
end      
...
faederdx(msg.chat_id_, msg.id_, 1, '☆↯*العضو* ( ['..data.first_name_..'](t.me/'..(data.username_ or 'sourcesela')..')'..' )\n☆↯*تم رفعه ( '..faederrt..' )\n☆↯*بواسطه ( '..renk_faeder(msg)..' )*\n*', 1, 'md')
...
if fdrt == "مميز" and is_momod(msg.sender_user_id_, msg.chat_id_) then
faederdx(msg.chat_id_, msg.id_, 1, '☆↯العضو ( ['..result.title_..'](t.me/'..(text1[3] or 'sourcesela')..')'..' )\n☆↯تم رفعه ( '..text1[2]..' )\n☆↯بواسطه ( '..renk_faeder(msg)..' )\n', 1, 'md')
...
local inline = {{{text="المطور",url="t.me/"..(SudoFaeder or "sourcesela")}}}
local Sudo_Welcome = '☆↯يمكنك ايضا استخدام الاوامر الخدميه \n☆↯اليك ازرار الاوامر الخدميه اسفل الرساله\n                  • ━━━ᵴᵉᴌẦ━━━ ┉ • ┉ • ┉ •\n                              [ᵴỖǕᏒḈE ᵴḔⱠẦ 𖡛 ](https://t.me/sourcesela)'
local key = {
{'زخرفه','احسب عمرك'},
{'الابراج','نسبه الحب'},
{'قسم الحمايه'},
...
if text == '•━━━ᵴᵉᴌẦ━━━ ┉•' then faederdx(msg.chat_id_, msg.id_, 1, '☆↯اختر لعبه من الكيبورد بالاسفل ،', 1, 'md') end
if Chat_Type == 'pv' then   
...
keyboard = {} -- الحقوق محفوظه لسورس فـارس لتخمط بدون ذكر المصدر
...
local text = text:gsub('user',(result.username_ or 'sourcesela'))
faederdx(msg.chat_id_, msg.id_, 1, text, 1, 'md')
end 
...
local text = text:gsub('user',(msg.content_.members_[0].username_ or 'sourcesela'))
faederdx(msg.chat_id_, msg.id_, 1, text, 1, 'md')
end
--      By Developer Sela      -- 
-------- Contact
...
File:write(t)
File:close()
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, './'..FAEDER..'.json', '☆↯عدد جروبات البوت : '..#list..'',dl_cb, nil)
end
--      By Developer Sela      -- 
...
if text == 'اخبارك اي' or text == 'شونج' or text == 'شلونك' or text == 'شلونج' or text == 'شونكم' or text == 'شلونكم' or text == 'شلخبار' or text == 'شلون الاخبار' or text == 'شخبارك' then if not faederdx1:get(FAEDER..'bot:rep:mute'..msg.chat_id_) then  local faeder = {  "ني زينن وانت يعمريي 🥺💘" ,  "ماشيهه يعمري 😻💘",  "تمامم عمرري وانتت 🤤💘", } faederdx12 = math.random(#faeder) faederdx(msg.chat_id_, msg.id_, 1, faeder[faederdx12] , 1, 'md') faederdx(msg.chat_id_, msg.id_, 1, faeder, 1, 'md') end end
if text == 'وينك' or text == 'فينك' then  if not faederdx1:get(FAEDER..'bot:rep:mute'..msg.chat_id_) then faeder =  "مْوٌجہوٌدِ يہمْگُ يحلوُ  😉♥️" else faeder = '' end faederdx(msg.chat_id_, msg.id_, 1, faeder, 1, 'md') end
...
if text == 'سورس فـارس' or text == 'سورس ديف فـارس' or text == 'سورس انور'  then if not faederdx1:get(FAEDER..'bot:rep:mute'..msg.chat_id_) then faeder =  "تااج وباجج حبيي ، 😹🌝" else faeder = '' end faederdx(msg.chat_id_, msg.id_, 1, faeder, 1, 'md') end 
...
if text == 'بحبك' then  if not faederdx1:get(FAEDER..'bot:rep:mute'..msg.chat_id_) then local faeder =  { "ٰجذابب يريد يطككج ، 😹💘","ااخ بسس اموتت بيكك ، 🥺💘" } faederdx12 = math.random(#faeder) faederdx(msg.chat_id_, msg.id_, 1, faeder[faederdx12] , 1, 'md') end end
if text == 'بوت' and faeder11(msg) then  name_bot = (faederdx1:get('faeder:'..bot_id..'name_bot') or 'فـارس')  local faeder = {  "أسمي "..name_bot.." يعمري ",  "أسمي "..name_bot.." يقميل ",  "تره أسمي "..name_bot.." كافي بوت ",  "انت البوت لك اسمي "..name_bot.." ", }  faeder2 = math.random(#faeder) faederdx(msg.chat_id_, msg.id_, 1, faeder[faeder2] , 1, 'md')  end
if (text and text == (faederdx1:get('faeder:'..bot_id..'name_bot') or 'فـارس')) then name_bot = (faederdx1:get('faeder:'..bot_id..'name_bot') or 'فـارس') local namebot = {  'عيون '..name_bot..' العسليات ؛🤭☄',  'اطلقق من يصيح '..name_bot..' ؛😻💗',  'وياك '..name_bot..' عمري أمرني 🌾' } name = math.random(#namebot) faederdx(msg.chat_id_, msg.id_, 1, namebot[name] , 1, 'md') return false end
--      By Developer Sela      -- 
...
--      By Developer Sela      -- 
if text == 'تويت' and faeder11(msg) then
if faederdx1:get(FAEDER..'bot:lock_geam'..msg.chat_id_) then
faederdx(msg.chat_id_, msg.id_, 1, '☆↯الالعاب معطله من قبل الادمن \n☆↯ارسل { تفعيل اللعبه } لتفعيلها ', 1, 'md')
return "faeder"
end
...
if text == "تيست" or text == "تيست البوت" and faeder11(msg) then
...
faederdx(msg.chat_id_, msg.id_, 1, '☆↯شغال وصلاحياته هي ⬇️\n         • ━━━ᵴᵉᴌẦ━━━ ┉ • ┉ • ┉ •\n☆↯حذف الرسائل ، '..DEL..'\n☆↯دعوة المستخدمين ، '..INV..'\n☆↯حظر المستخدمين ، '..BAN..'\n☆↯تثبيت الرسائل ، '..PIN..'\n☆↯تغيير المعلومات ، '..EDT..'\n☆↯اضافة مشرفين ، '..VIP..'\n         • ━━━ᵴᵉᴌẦ━━━ ┉ • ┉ • ┉ •\n☆↯قناة السورس ، [@sourcesela]', 1, 'md')
end end end
--      By Developer Sela      -- 
 if is_admin(msg.sender_user_id_, msg.chat_id_) then
name_bot = (faederdx1:get('faeder:'..bot_id..'name_bot') or 'فـارس')
...
{text="- فـارس الغدار،",url="t.me/IE_S9"}},
...
send_inline(msg.chat_id_,'☆↯  فـارس سيلا┋Sela ،\n☆↯اضغط على الازرار بالاسفل ⬇️ ،',nil,inline) 
return false 
end
--      By Developer Sela      -- 
...
if tonumber(result.id_) == tonumber(1059262308) then 
faederdx(msg.chat_id_, msg.id_, 1, 'دي لك تريد اهين تاج راسك فـارس الغدار ؟ 🌚🙆', 1, 'md') 
return false  
end  
...
-------- Set Sudo3
if is_sudo(msg) then
if text ==('رفع مطور') or text ==('رفع مطور') or text ==('اضف مطور') and faeder11(msg) then
function sudo_reply(extra, result, success)
faederdx1:sadd(FAEDER..'bot:admins:',result.sender_user_id_)
Send_Options(msg,result.sender_user_id_,"reply","☆↯تم رفعه مطور𓍢\n☆↯بواسطه ، "..renk_faeder(msg).."\n")
end 
...
Send_Options(msg,result.id_,"reply","☆↯تم رفعه مطور𓍢\n☆↯بواسطه ، "..renk_faeder(msg).."\n")
else 
...
--      By Developer Sela      -- 
-------- Rem Sudo3
if text ==('تنزيل مطور') or text ==('تنزيل مطور') or text ==('حذف مطور') and faeder11(msg) then
function prom_reply(extra, result, success)
faederdx1:srem(FAEDER..'bot:admins:',result.sender_user_id_)
Send_Options(msg,result.sender_user_id_,"reply","☆↯تم تنزيله من المطورين𓍢\n☆↯بواسطه ، "..renk_faeder(msg).."\n")
end 
if tonumber(tonumber(msg.reply_to_message_id_)) == 0 then
else
...
--      By Developer Sela      -- 
if msg.reply_to_message_id_ ~= 0 then  
if text:match("^فك التقييد $") or text:match("^الغاء تقيد$") and faeder11(msg) then
function mute_by_reply(extra, result, success)
local user_info_ = faederdx1:get(FAEDER..'user:Name' .. result.sender_user_id_)
local faeder_res = user_info_
if user_info_ then
...
return false  end
if res.id_ then  
if tonumber(res.id_) == tonumber(1059262308) then
t = 'فـارس الغدار  '
...
if tonumber(iduser) == tonumber(1059262308) then
t = 'فـارس الغدار  '
...
if #group == i then 
if (w + q) == 0 then
faederdx(msg.chat_id_, msg.id_, 1,'☆↯لا يوجد جروبات وهميه ،\n', 1, 'md')
else
...
faederdx(msg.chat_id_, msg.id_, 1, '☆↯تم تنظيف عدد رسائل الجروبات ', 'md')
end
--      By Developer Sela      -- 
if is_momod(msg.sender_user_id_, msg.chat_id_) then
...
faederdx1:set(FAEDER.."bot:group:link"..msg.chat_id_,(t2.invite_link_ or "@sourcesela")) 
...
--      By Developer Sela      -- 
if text and text:match("^تفعيل كل الجروبات$") and faeder11(msg) then
...
if text and text:match("^تعطيل كل الجروبات$") and faeder11(msg) then
local gps = faederdx1:smembers(FAEDER.."bot:groups") or 0
local gps2 = faederdx1:smembers("faeder:addg"..bot_id) or 0
for i=1,#gps do
...
local list = faederdx1:smembers(FAEDER.."bot:groups")
local text = "~ Groups_Bots_In_the_Bot_Of_Source_Faeder ~ @sourcesela\n\n"
for k,v in pairs(list) do
...
--      By Developer Sela      -- 
if  msg.content_.text_ == "الردود العامه" and is_sudo(msg) or msg.content_.text_ == "الردود العام" and is_sudo(msg) or msg.content_.text_ == "ردود العام" and is_sudo(msg) then
local redod = faederdx1:smembers(FAEDER.."rep_sudo")
if #redod == 0 then
faederdx(msg.chat_id_, msg.id_, 1, "☆↯لا توجد ردود مضافه" ,  1, "md")
else
local i = 1
msg_rep = "☆↯الردود العامه ⬇️،\n         • ━━━ᵴᵉᴌẦ━━━ ┉ • ┉ • ┉ •\n"
for k,v in pairs(redod) do
...
--      By Developer Sela      -- 
if msg.content_.text_ == "حذف الردود العامه" and is_sudo(msg) or msg.content_.text_ == "حذف ردود العام" and is_sudo(msg) or msg.content_.text_ == "مسح الردود العامه" and is_sudo(msg) then
local redod = faederdx1:smembers(FAEDER.."rep_sudo")
if #redod == 0 then
faederdx(msg.chat_id_, msg.id_, 1, "☆↯لا توجد ردود مضافه" ,  1, "md")
else
...
os.execute('wget https://raw.githubusercontent.com/Zoro283/Sela/master/FAEDER.lua') 
...
print('\27[30;32m»» جاري تيست الجروبات الوهميه ««\n\27[1;37m')
local list = faederdx1:smembers(FAEDER..'bot:userss')  
for k,v in pairs(list) do
