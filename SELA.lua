...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/zoro283/Files_Sela/master/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1014038266,1059262308,1033028167}   
...
if hash or SudoBot(msg) or DevSELAW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevSELAW(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevSELAW(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevSELAW(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevSELAW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevSELAW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevSELAW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then       
return true 
else 
return false 
end 
...
if tonumber(user_id) == tonumber(1014038266) then  
var = true  
...
function plugin_sela(msg)
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
plugin = dofile("File_Bot/"..v)
if plugin.sela and msg then
pre_msg = plugin.sela(msg)
end
end
end
...
if not DevSELAW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevSELAW(msg) and msg.reply_to_message_id_ ~= 0  then    
...
if text == 'تفعيل التواصل ♡' and DevSELAW(msg) then  
...
if text == 'تعطيل التواصل ♡' and DevSELAW(msg) then  
...
if text == 'تفعيل البوت الخدمي ♡' and DevSELAW(msg) then  
...
if text == 'تعطيل البوت الخدمي ♡' and DevSELAW(msg) then  
...
if text == 'ضع كليشه ستارت ♡' and DevSELAW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' ☆↯⇠ ارسل لي الكليشه الان')
return false
end
if text == 'مسح كليشه ستارت ♡' and DevSELAW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' ☆↯⇠ تم مسح كليشه ستارت')
end
if text == 'معلومات السيرفر ♡' and DevSELAW(msg) then 
...
if text == 'تحديث السورس ♡' and DevSELAW(msg) then 
os.execute('rm -rf SELA.lua')
os.execute('wget https://raw.githubusercontent.com/zoro283/SELA/master/SELA.lua')
send(msg.chat_id_, msg.id_,' ☆↯⇠ تم تحديث السورس \n ☆↯⇠ لديك اخر اصدار لسورس سيلا\n ☆↯⇠ الاصدار » { 1.3v}')
dofile('SELA.lua')  
end
if text == 'الاصدار ♡' and DevSELAW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ☆↯⇠ اصدار سورس سيلا \n ☆↯⇠ الاصدار »{ 1.3v}')
end
if text == 'قناه تحديثات البوت ♡' and DevSELAW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ☆↯⇠ [تحديثات البوت](t.me/sourcesela) \n ☆↯⇠ [قناه السورس](t.me/sourcesela)')
end
if text == "ضع اسم للبوت ♡" and DevSELAW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," ☆↯⇠ ارسل اليه الاسم الان ")
return false
end
if text == 'الاحصائيات ♡' and DevSELAW(msg) then 
...
if text == 'المشتركين ♡' and DevSELAW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ☆↯⇠ المشتركين»{`'..Users..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الجروبات ♡' and DevSELAW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ☆↯⇠ الجروبات»{`'..Groups..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ♡") and DevSELAW(msg) then
...
if text == ("قائمه العام ♡") and DevSELAW(msg) then
...
if text == ("قائمه الكتم العام ♡") and DevSELAW(msg) then
...
if text=="اذاعه خاص ♡" and msg.reply_to_message_id_ == 0 and DevSELAW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ☆↯⇠ ارسل الان اذاعتك؟ \n ☆↯⇠ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه ♡" and msg.reply_to_message_id_ == 0 and DevSELAW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ☆↯⇠ ارسل الان اذاعتك؟ \n ☆↯⇠ للخروج ارسل الغاء ")
return false
end  
if text=="اذاعه بالتثبيت ♡" and msg.reply_to_message_id_ == 0 and DevSELAW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ☆↯⇠ ارسل الان اذاعتك؟ \n ☆↯⇠ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه بالتوجيه ♡" and msg.reply_to_message_id_ == 0  and DevSELAW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ☆↯⇠ ارسل لي التوجيه الان")
return false
end 
if text=="اذاعه بالتوجيه خاص ♡" and msg.reply_to_message_id_ == 0  and DevSELAW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ☆↯⇠ ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ♡' and DevSELAW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ♡" and DevSELAW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف الجروبات ♡" and DevSELAW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع مطور @(.*)$") and DevSELAW(msg) then
...
if text and text:match("^رفع مطور (%d+)$") and DevSELAW(msg) then
...
if text and text:match("^تنزيل مطور @(.*)$") and DevSELAW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevSELAW(msg) then
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevSELAW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevSELAW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevSELAW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ☆↯⇠ حسنآ ارسل لي معرف القناة')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevSELAW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ☆↯⇠ حسنآ ارسل لي النص الذي تريده')
return false  
end
if text == "مسح رساله الاشتراك ♡" and DevSELAW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " ☆↯⇠ تم مسح رساله الاشتراك ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ♡$") and DevSELAW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ☆↯⇠ حسنآ ارسل لي معرف القناة')
return false  
end
if text == "تفعيل الاشتراك الاجباري ♡" and DevSELAW(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري ♡" and DevSELAW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " ☆↯⇠ تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "الاشتراك الاجباري ♡" and DevSELAW(msg) then  
...
database:sadd(bot_id.."SELA:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."SELA:blocname"..msg.chat_id_)
...
if t2.id_ then 
name_Sela = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_Sela then 
names_Sela = database:smembers(bot_id.."SELA:blocname"..msg.chat_id_) or ""
if names_Sela and names_Sela[1] then 
for i=1,#names_Sela do 
if name_Sela:match("(.*)("..names_Sela[i]..")(.*)") then 
...
database:set(bot_id.."SELA:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."SELA:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."SELA:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."SELA:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."SELA:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_Selaa_new(Sela1,Sela2)
if Sela2 and Sela2.first_name_ then 
if Sela2.first_name_:match("(.*)"..database:get(bot_id.."SELA:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."SELA:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local Sela_nnn = database:get(bot_id.."SELA:nump"..msg.chat_id_) or 5
local Sela_nnn2 = database:get(bot_id.."SELA:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(Sela_nnn2) == tonumber(Sela_nnn) or tonumber(Sela_nnn2) > tonumber(Sela_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."SELA:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "☆↯⇠ عزيزي >>["..Sela2.username_.."](https://t.me/"..(Sela2.username_ or "sourcesela")..")\n☆↯⇠ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."SELA:teh"..msg.chat_id_).."} بجانب اسمك\n☆↯⇠ عدد المحاولات المتبقيه {"..(tonumber(Sela_nnn) - tonumber(Sela_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_Selaa_new)
end
end
...
local SELAChengName = database:get(bot_id.."SELA:Cheng:Name"..data.id_)
if not data.first_name_ then 
if SELAChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..SELAChengName..']')
database:del(bot_id.."SELA:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if SELAChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."SELA:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local SELAChengUserName = database:get(bot_id.."SELA:Cheng:UserName"..data.id_)
if not data.username_ then 
if SELAChengUserName then 
send(msg.chat_id_, msg.id_, 1, "مسح معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..SELAChengUserName..']')
database:del(bot_id.."SELA:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if SELAChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."SELA:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local SELAChengPhoto = database:get(bot_id.."SELA:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if SELAChengPhoto then 
send(msg.chat_id_, msg.id_, "مسح كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."SELA:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if SELAChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."SELA:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
if text == 'رفع نسخه الاحتياطيه' and DevSELAW(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
--------------------------------------------------------------------------------------------------------------
if text == 'تحديث' and DevSELAW(msg) then    
dofile('SELA.lua')  
send(msg.chat_id_, msg.id_, ' ☆↯⇠ تم تحديث جميع الملفات') 
end 
if text == ("مسح قائمه العام") and DevSELAW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevSELAW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^حظر عام @(.*)$")  and DevSELAW(msg) then
...
if text and text:match("^حظر عام (%d+)$") and DevSELAW(msg) then
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevSELAW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and DevSELAW(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevSELAW(msg) then
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevSELAW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء العام @(.*)$") and DevSELAW(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevSELAW(msg) then
...
------------------------------------------------------------------------
if text == ("مسح المطورين") and DevSELAW(msg) then
...
if text == 'الملفات' and DevSELAW(msg) then
t = ' ☆↯⇠ ملفات السورس سيلا ↓\n≪━━━━━━ᵴᵉᴌẦ━━━━━≫ \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
...
if DevSELAW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/zoro283/Files_Sela/master/getfile.json")
if res == 200 then
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevSELAW(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/zoro283/Files_Sela/master/File_Bot/"..file)
if res == 200 then
...
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevSELAW(msg) then
...
if text == "مسح الملفات" and DevSELAW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," ☆↯⇠ تم مسح الملفات")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevSELAW(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevSELAW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("نادي للمالك") or text == ("تاك للمالك") then
local list = database:smembers(bot_id..'CoSu'..msg.chat_id_)
...
function Function_SELA(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_SELA, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_SELA, nil)
return false 
end
...
if text == 'مسح كليشه المطور' and DevSELAW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' ☆↯⇠ تم مسح كليشه المطور')
end
if text == 'ضع كليشه المطور' and DevSELAW(msg) then
...
if text == 'تفعيل الاذاعه' and DevSELAW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevSELAW(msg) then  
...
if database:get(bot_id..'Bc:Bots') and not DevSELAW(msg) then 
...
if text == ("مسح الردود العامه") and DevSELAW(msg) then 
...
if text == ("الردود العامه") and DevSELAW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ☆↯⇠ قائمة الردود العامه \n≪━━━━━━ᵴᵉᴌẦ━━━━━≫\n"
for k,v in pairs(list) do
...
if text == 'اضف رد عام' and DevSELAW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'مسح رد عام' and DevSELAW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'تفعيل المغادره' and DevSELAW(msg) then   
...
if text == 'تعطيل المغادره' and DevSELAW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n☆↯⇠ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SELA')..') '
...
if text == 'ايدي' or text == "id" and tonumber(msg.reply_to_message_id_) > 0 then
function start_function(extra, result, success)
...
if text == 'استعاده الاوامر' and DevSELAW(msg) then
...
zh = https.request('https://rudi-dev.tk/Amir1/Sela.php?en='..URL.escape(TextZhrfa)..'')
zx = JSON.decode(zh)
t = "\n☆↯⇠ قائمه الزخرفه \nٴ☆↯⇠ٴ≪━━━━━━ᵴᵉᴌẦ━━━━━≫ٴ☆↯⇠○ٴ \n"
i = 0
...
send(msg.chat_id_, msg.id_, t..'ٴ☆↯⇠ٴ≪━━━━━━ᵴᵉᴌẦ━━━━━≫ٴ☆↯⇠○ٴ\n☆↯⇠ 彡 .[ᵴḔᴌẤ 𝘊𝘩𝘢𝘯𝘯𝘦𝘭](t.me/sourcesela)➢ ')
end
...
gk = https.request('https://rudi-dev.tk/Amir2/Sela.php?br='..URL.escape(Textbrj)..'')
br = JSON.decode(gk)
i = 0
...
ge = https.request('https://rudi-dev.tk/Amir3/Sela.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
i = 0
...
--------------------------------------------------------------------------------------------------------------
SourceSELA(data.message_,data)
plugin_sela(data.message_)
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ then
