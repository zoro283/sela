...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/zoro283/Files_Boyka/master/File_Bot/commands.lua") 
...
if name_Boyka then 
names_Boyka = database:smembers(bot_id.."SELA:blocname"..msg.chat_id_) or ""
...
if Boyka2.first_name_:match("(.*)"..database:get(bot_id.."SELA:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."SELA:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local Boyka_nnn = database:get(bot_id.."SELA:nump"..msg.chat_id_) or 5
local Boyka_nnn2 = database:get(bot_id.."SELA:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
...
if DevSELAW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/zoro283/Files_Boyka/master/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/zoro283/Files_Boyka/master/File_Bot/"..file)
if res == 200 then
