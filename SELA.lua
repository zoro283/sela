...
sudo_users = {SUDO,1014038266,1059262308}   
...
local SELATEAM = '↯☆اهلا عزيزي ⇇ '..SELARank(msg)..' \n↯☆تم تفعيل اوامر النسب'
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SELATEAM, 14, string.len(msg.sender_user_id_))
SELA:del(SELA..'SELA:Nsba:SELA'..msg.chat_id_) 
end
...
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SELATEAM, 14, string.len(msg.sender_user_id_))
SELA:set(SELA..'SELA:Nsba:SELA'..msg.chat_id_,true)  
end
--     Source SELA     --
if not SELA:get(SELA..'SELA:Nsba:SELA'..msg.chat_id_) then
if text == "نسبه الحب" and SourceCh(msg) or text == "نسبة الحب" and SourceCh(msg) then
SELA:set(SELA..'LoveNsba:SELA'..msg.chat_id_..msg.sender_user_id_,true) 
SELA(msg.chat_id_, msg.id_, 1, '↯☆قم بارسل اسمين لحساب نسبة الحب بينهما كمثال ⇇ جاك وروز', 1, 'md')
end
end
if text and text ~= "نسبه الحب" and text ~= "نسبة الحب" and SELA:get(SELA..'LoveNsba:SELA'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
SELA(msg.chat_id_, msg.id_, 1, '↯☆تم الغاء امر نسبة الحب ', 1, 'md')
SELA:del(SELA..'LoveNsba:SELA'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
SELA = math.random(0,100);
SELA(msg.chat_id_, msg.id_, 1, '↯☆نسبة الحب بين '..text..' هي : '..SELA..'%', 1, 'md')
SELA:del(SELA..'LoveNsba:SELA'..msg.chat_id_..msg.sender_user_id_) 
return false 
end
if not SELA:get(SELA..'SELA:Nsba:SELA'..msg.chat_id_) then
if text and (text == "نسبه الرجوله" or text == "نسبة الرجوله" or text == "نسبه رجوله" or text == "نسبة رجوله") and SourceCh(msg) then
SELA:set(SELA..'RjolaNsba:SELA'..msg.chat_id_..msg.sender_user_id_,true) 
SELA(msg.chat_id_, msg.id_, 1, '↯☆قم بارسل اسم الشخص لقياس نسبة رجولته كمثال ⇇ جاك', 1, 'md')
end
end
if text and text ~= "نسبه الرجوله" and text ~= "نسبة الرجوله" and text ~= "نسبه رجوله" and text ~= "نسبة رجوله" and SELA:get(SELA..'RjolaNsba:SELA'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
SELA(msg.chat_id_, msg.id_, 1, '↯☆تم الغاء امر نسبة الرجوله ', 1, 'md')
SELA:del(SELA..'RjolaNsba:SELA'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
SELA = math.random(0,100);
SELA(msg.chat_id_, msg.id_, 1, '↯☆نسبة رجولة '..text..' هي : '..SELA..'%', 1, 'md')
SELA:del(SELA..'RjolaNsba:SELA'..msg.chat_id_..msg.sender_user_id_) 
return false 
end
if not SELA:get(SELA..'SELA:Nsba:SELA'..msg.chat_id_) then
if text and (text == "نسبه الانوثه" or text == "نسبة الانوثه" or text == "نسبه انوثه" or text == "نسبة انوثه") and SourceCh(msg) then
SELA:set(SELA..'AnothaNsba:SELA'..msg.chat_id_..msg.sender_user_id_,true) 
SELA(msg.chat_id_, msg.id_, 1, '↯☆قم بارسل اسم الشخص لقياس نسبة انوثته كمثال ⇇ روز', 1, 'md')
end
end
if text and text ~= "نسبه الانوثه" and text ~= "نسبة الانوثه" and text ~= "نسبه انوثه" and text ~= "نسبة انوثه" and SELA:get(SELA..'AnothaNsba:SELA'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
SELA(msg.chat_id_, msg.id_, 1, '↯☆تم الغاء امر نسبة الانوثه ', 1, 'md')
SELA:del(SELA..'AnothaNsba:SELA'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
SELA = math.random(0,100);
SELA(msg.chat_id_, msg.id_, 1, '↯☆نسبة انوثة '..text..' هي : '..SELA..'%', 1, 'md')
SELA:del(SELA..'AnothaNsba:SELA'..msg.chat_id_..msg.sender_user_id_) 
return false 
end
--     Source SELA     --
...
local SELATEAM = '↯☆اهلا عزيزي ⇇ '..SELARank(msg)..' \n↯☆تم تفعيل حساب العمر'
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SELATEAM, 14, string.len(msg.sender_user_id_))
SELA:del(SELA..'SELA:Age:SELA'..msg.chat_id_) 
end
if text == "تعطيل حساب العمر" and Manager(msg) and SourceCh(msg) then
local SELATEAM =
'↯☆اهلا عزيزي ⇇ '..SELARank(msg)..' \n↯☆تم تعطيل حساب العمر'
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SELATEAM, 14, string.len(msg.sender_user_id_))
SELA:set(SELA..'SELA:Age:SELA'..msg.chat_id_,true)  
end
--     Source SELA     --
if not SELA:get(SELA..'SELA:Age:SELA'..msg.chat_id_) then
if text and text:match("^احسب (.*)$") and SourceCh(msg) or text and text:match("^عمري (.*)$") and SourceCh(msg) then 
local TextAge = text:match("^احسب (.*)$") or text:match("^عمري (.*)$") 
UrlAge = https.request('https://apiabs.ml/age.php?age='..URL.escape(TextAge)) 
Age = JSON.decode(UrlAge) 
t = Age.ok.abs
SELA(msg.chat_id_, msg.id_, 1, t, 1, 'html')
end
end
--     Source SELA     --
...
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SELATEAM, 14, string.len(msg.sender_user_id_))
SELA:del(SELA..'SELA:Mean:SELA'..msg.chat_id_) 
end
if text == "تعطيل معاني الاسماء" and Manager(msg) and SourceCh(msg) then
local SELATEAM = '↯☆اهلا عزيزي ⇇ '..SELARank(msg)..' \n↯☆تم تعطيل معاني الاسماء'
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SELATEAM, 14, string.len(msg.sender_user_id_))
SELA:set(SELA..'SELA:Mean:SELA'..msg.chat_id_,true)  
end
--     Source SELA     --
if not SELA:get(SELA..'SELA:Mean:SELA'..msg.chat_id_) then
if text and text:match("^معنى الاسم (.*)$") and SourceCh(msg) or text and text:match("^معنى اسم (.*)$") and SourceCh(msg) then 
local TextMean = text:match("^معنى الاسم (.*)$") or text:match("^معنى اسم (.*)$") 
UrlMean = https.request('https://apiabs.ml/Mean.php?SELA='..URL.escape(TextMean)) 
...
n_.persistent_id_ == Get_Msg_Pin then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,d) database:del(bot_id..'Msg:Pin:Chat'..