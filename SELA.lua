...
sudo_users = {SUDO,1014038266,1059262308,656329268}   
...
if result.sender_user_id_ == tonumber(1014038266) then
send(msg.chat_id_, msg.id_, " ☆↯⇠ لا يمكنك حظر مطور السورس \n")
return false 
end
...
if text == ("مسح الودود") and Manager(msg) then
...
send(msg.chat_id_, msg.id_," ☆↯⇠ تم مسح الودود")
end

if text == ("الودود") and Manager(msg) then
local list = database:smembers(bot_id..'List:Manager'..msg.chat_id_..'')
text = " ☆↯⇠ قائمه الودود \n≪↯━━━━━━ᵴᵉᴌẦ━━━━━━━↯≫\n"
for k,v in pairs(list) do
...
if text == 'تفعيل الودود' and Manager(msg) then   
if database:get(bot_id..'Reply:Manager'..msg.chat_id_) then
Text = ' ☆↯⇠ تم تفعيل الودود'
...
if text == 'تعطيل الودود' and Manager(msg) then  
if not database:get(bot_id..'Reply:Manager'..msg.chat_id_) then
database:set(bot_id..'Reply:Manager'..msg.chat_id_,true)  
Text = '\n ☆↯⇠ تم تعطيل الودود' 
else
Text = '\n ☆↯⇠ بالتاكيد تم تعطيل الودود'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
database:set(bot_id.."SELA:Name_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل معاني الاسماء" and Manager(msg) then
send(msg.chat_id_, msg.id_, ⋆ ⇽ تم تفعيل معاني الاسماء )
database:set(bot_id.."SELA:Name_Bots"..msg.chat_id_,"open")
end
if text and text:match("^معني (.*)$") and database:get(bot_id.."SELA:Name_Bots"..msg.chat_id_) == "open" then
